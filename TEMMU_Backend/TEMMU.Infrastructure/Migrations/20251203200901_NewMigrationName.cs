...
namespace TEMMU.Infrastructure.Migrations
{
    /// <inheritdoc />
    public partial class NewMigrationName : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Fighters",
                columns: new[] { "Id", "attackMultiplier", "defenseMultiplier", "healthBase", "matchesPlayed", "name", "speed", "style", "wins" },
                values: new object[,]
                {
                    { 1, 1.2, 0.90000000000000002, 1000, 50, "Kai", 8, "Karate", 45 },
                    { 2, 1.0, 1.1000000000000001, 950, 50, "Lana", 6, "Judo", 20 }
                });
